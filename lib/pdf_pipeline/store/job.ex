defmodule PdfPipeline.Store.Job do
  @moduledoc """
  ETS-based job state tracking for pipeline processing.

  Tracks the state of PDF ingestion jobs through the pipeline stages.
  """

  use GenServer

  @table :pdf_pipeline_jobs
  ...
  defp broadcast(job) do
    Phoenix.PubSub.broadcast(PdfPipeline.PubSub, "jobs", {:job_updated, job})
  end
end
