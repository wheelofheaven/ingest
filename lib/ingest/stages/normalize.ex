defmodule Ingest.Stages.Normalize do
  @moduledoc """
  ...
  alias Ingest.Parser.RuleEngine
  alias Ingest.Refiner.Strategy
  alias Ingest.Schema.Book
  alias Ingest.Stages.WorkDir
  ...
  defp load_text(slug, opts) do
    case Keyword.get(opts, :text) do
      nil ->
        case Ingest.Stages.OCR.load(slug) do
          {:ok, text} -> {:ok, text}
