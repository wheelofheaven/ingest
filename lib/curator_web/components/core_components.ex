defmodule CuratorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CuratorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CuratorWeb.Gettext, "errors", msg, opts)
    end
  end
