defmodule Curator.Export.DataLibrary do
  @moduledoc """
  ...
  alias Curator.Schema.{Book, Validator}
  alias Curator.Export.{SingleFile, SplitFile}
  ...
  def export(%Book{} = book, output_dir \\ nil) do
    output_dir = output_dir || Application.get_env(:curator, :data_library_path, "../data-library")
    languages = Application.get_env(:curator, :default_languages, ~w(en fr de es ru ja zh))
