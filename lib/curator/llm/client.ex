defmodule Curator.LLM.Client do
  @moduledoc """
  ...
  defp chat_zai(prompt, opts) do
    api_key = Application.get_env(:curator, :zai_api_key)
  ...
  defp chat_anthropic(prompt, opts) do
    api_key = Application.get_env(:curator, :anthropic_api_key)
  ...
  defp default_provider do
    cond do
      Application.get_env(:curator, :zai_api_key) -> :zai
      Application.get_env(:curator, :anthropic_api_key) -> :anthropic
      true -> :zai
    end
  end
