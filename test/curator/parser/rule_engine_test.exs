defmodule Curator.Parser.RuleEngineTest do
  use ExUnit.Case, async: true

  alias Curator.Parser.RuleEngine
  alias Curator.Parser.Rules.{ChapterRules, ParagraphRules, SpeakerRules}
  alias Curator.Parser.TextUtils
  ...
  describe "SpeakerRules.detect_speakers/2" do
    test "detects known speakers" do
      paragraphs = [
        %Curator.Schema.Paragraph{n: 1, text: "Yahweh: Hello", confidence: 1.0},
        %Curator.Schema.Paragraph{n: 2, text: "Just narration.", confidence: 1.0}
      ]
    ...
    test "flags dialogue with unknown speaker" do
      paragraphs = [
        %Curator.Schema.Paragraph{n: 1, text: "\u2014 Some dialogue", confidence: 1.0}
      ]
